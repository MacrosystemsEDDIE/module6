...
\
*Table 2. Water Temperature Statistics*
```{r}
knitr::kable(wtemp_tab) 
```
\
7. `r substr(quest["q7", ], 4, nchar(quest["q7", ]))`    
\
*Table 3. Air Temperature Statistics*
```{r}
knitr::kable(atemp_tab) 
```
\
...
\
![](www/example_linear_relationship.png)
**Answer:**
\
...
*Table 5. Multiple Linear Regression Parameters*
```{r}
knitr::kable(mlr_pars_tab) 
```
\
...
*Table 6. Parameters for Linear Regressions Fit to Different Datasets*
```{r}
knitr::kable(evolving_pars_tab) 
```
\
