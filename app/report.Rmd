...
Table 2. Linear regression models fitted using data collected at different frequencies.

| **Frequency** | **Slope (m)** | **Intercept (b)** | **N** | **RMSE** |
| --- | --- | --- | --- | --- |
| Monthly | `r tab_lr[1, "m_est"]` | `r tab_lr[1, "b_est"]` | `r tab_lr[1, "N"]` | `r tab_lr[1, "rmse"]` |
| Fortnightly | `r tab_lr[2, "m_est"]` | `r tab_lr[2, "b_est"]` | `r tab_lr[2, "N"]` | `r tab_lr[2, "rmse"]` |
| Weekly |`r tab_lr[3, "m_est"]` | `r tab_lr[3, "b_est"]` | `r tab_lr[3, "N"]` | `r tab_lr[3, "rmse"]` |
| Daily | `r tab_lr[4, "m_est"]` | `r tab_lr[4, "b_est"]` | `r tab_lr[4, "N"]` | `r tab_lr[4, "rmse"]` |
\
...
```
\
Table 3. Models fit to the data that are more suitable for forecasting.
...
Table 4. Models that are used to explore forecast uncertainty.
